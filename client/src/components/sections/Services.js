...
export const Services = () => {
  const [services] = useState([
    {
      title: "Устанавливаем видеонаблюдение",
      description:
        "Устанавливаем систему видеонаблюдения в квартирах, домах, магазинах, складах, заводах, школах, детских садах и т.д. Работаем как с  физическими лицами так и с юридическими.",
    },
    {
      title: "Устанавливаем домофоны",
      description:
        "Устанавливаем домофоны в квартиры и частные дома. Так же занимаемся продажей, ремонтом и обслуживанием",
    },
    {
